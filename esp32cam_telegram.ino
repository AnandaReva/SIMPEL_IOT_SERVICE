...
const char* ssid = "Galaxy A7 (2018)BD92";
const char* password = "keshgans";

// definisi telegram bot token yang didapat di bot father
String BOTtoken = "6969578788:AAEaVzU6NZ8dJw76qNbtfKCWUAL-d1NNvzU";  // your Bot Token (Get from Botfather)

// definisi id dari telegram user
String CHAT_ID = "2097304560";
